  ...
  public class EncriptaDecriptaRC4 {
      ...
      public static void main(String[] args) {
          try {
               ...
               EncriptaDecriptaRC4 rc4 = new EncriptaDecriptaRC4( JOptionPane.showInputDialog("Digite a chave"));
              char[] textoCriptografado = rc4.criptografa( JOptionPane.showInputDialog("Digite o texto").toCharArray());
